      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-4">
          ...
          <select
            ...
            :class="{ 'border-red-500': form.errors.team_a_id }"
          >
          ...
          <p v-if="form.errors.team_a_id" class="text-red-500 text-sm mt-1">
        ...
        <div class="mb-4">
          ...
          <select
            ...
            class="w-full p-2 border rounded"
            :class="{ 'border-red-500': form.errors.team_b_id }"
          >
          ...
          <p v-if="form.errors.team_b_id" class="text-red-500 text-sm mt-1">
        ...
        <div class="mb-4">
          ...
          />
          <p v-if="form.errors.team_a_goals" class="text-red-500 text-sm mt-1">
        ...
        <div class="mb-4">
          ...
          />
          <p v-if="form.errors.team_b_goals" class="text-red-500 text-sm mt-1">
        ...
        <div class="mb-4">
          ...
          <select
            ...
            class="w-full p-2 border rounded"
            :class="{ 'border-red-500': form.errors.winner_team_id }"
          >
          ...
          <p
            v-if="form.errors.winner_team_id"
