  ...
  <AppLayout title="Edit Team">
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-4">
      ...
      <form @submit.prevent="submit" class="space-y-4">
        <!-- Team Name -->
        <div>
          <label for="name" class="block text-lg font-medium text-gray-600"
            >Team Name</label
          >
          <input
            v-model="form.name"
        ...
        <!-- Team Logo Upload -->
        <div>
          <label for="logo" class="block text-lg font-medium text-gray-600"
            >Team Logo</label
          >
          <input
            type="file"
        ...
        <div>
          <label
            for="description"
            class="block text-lg font-medium text-gray-600"
            >Description</label
          >
          <textarea
...
const form = useForm({
  ...
  logo: null, // you can handle logo update differently if needed
...
// Submit the form to update the team
const submit = () => {
